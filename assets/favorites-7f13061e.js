import{a as m}from"./hamburger-menu-2b8debd2.js";const y=e=>e.map(s=>{const{_id:t,title:r,description:a,thumb:n,rating:l}=s;let o=Math.round(l);return`<div class="fav-card"
