import{r as g}from"./hamburger-menu-38d5171e.js";const f=document.querySelector(".js-list-fav"),v=document.querySelector(".js-fav-wrapper"),c=document.querySelector(".js-hero-img");document.querySelector(".recipe-btn");document.querySelector(".recipe-card");window.addEventListener("resize",p);p();function p(){window.innerWidth<768&&c.classList.add("visually-hidden"),window.innerWidth>=768&&c.classList.remove("visually-hidden")}let n=localStorage.getItem("favoriteRecipes"),a=n?JSON.parse(n):[];a=Array.isArray(a)?a:[];function y(e,i){let r,t;if(e.length)r=g(a),c.classList.remove("visually-hidden"),f.innerHTML=r;else return t=`<div class="hero-mob-wrapper">
