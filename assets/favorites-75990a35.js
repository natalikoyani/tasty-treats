import{a as m}from"./hamburger-menu-2e03367e.js";const y=e=>e.map(s=>{const{_id:t,title:r,description:a,thumb:n,rating:l}=s;let o=Math.round(l);return`<div class="fav-card"
    ...
    </div>`}).join(""),h=document.querySelector(".js-list-fav"),b=document.querySelector(".js-fav-wrapper"),g=document.querySelector(".js-hero-img");document.querySelector(".recipe-btn");document.querySelector(".recipe-card");window.addEventListener("resize",f);f();function f(){window.innerWidth<768&&g.classList.add("visually-hidden"),window.innerWidth>=768&&g.classList.remove("visually-hidden")}let d=localStorage.getItem("favoriteRecipes"),i=d?JSON.parse(d):[];i=Array.isArray(i)?i:[];function S(e,s){let t,r;if(e.length)t=y(i),g.classList.remove("visually-hidden"),h.innerHTML=t;else return r=`<div class="hero-mob-wrapper">
